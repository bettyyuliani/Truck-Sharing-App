...
import com.example.task101.databinding.ActivityCheckoutBinding;
import com.example.task101.util.Util;
import com.example.task101.viewmodel.CheckoutViewModel;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private void initializeUi() {
        ...
        // get data passed from fragment order and to map activity, used for displays
        ...
        width = intent.getStringExtra(Util.LENGTH);
        length = intent.getStringExtra(Util.LENGTH);
        height = intent.getStringExtra(Util.HEIGHT);
        goodImageBytesArray = intent.getByteArrayExtra(Util.GOOD_IMAGE);

        // get views
        TextView receiverNameTextView = findViewById(R.id.receiverCheckoutTV);
        TextView dateTextView = findViewById(R.id.dateCheckoutTV);
        TextView timeTextView = findViewById(R.id.timeCheckoutTV);
        TextView locationTextView = findViewById(R.id.locationCheckoutTV);
        TextView destinationTextView = findViewById(R.id.destinationCheckoutTV);
        TextView goodTypeTextView = findViewById(R.id.goodTypeCheckoutTV);
        TextView vehicleTypeTextView = findViewById(R.id.vehicleTypeTVcheckout);
        TextView weightTextView = findViewById(R.id.weightCheckoutTV);
        TextView lengthTextView = findViewById(R.id.lengthCheckoutTV);
        TextView heightTextView = findViewById(R.id.heightCheckoutTV);
        TextView widthTextView = findViewById(R.id.widthCheckoutTV);
